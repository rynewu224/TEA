...
user_meta_paths = [['click', 'click-by'], ['follow']]
item_meta_paths = [['click-by', 'click']]

# Meta edge droprates for Epinions
# user_meta_edge_droprates = [0.5, 0.0]
# item_meta_edge_droprates = [0.9]

# Meta edge droprates for Yelp
user_meta_edge_droprates = [0.95, 0.0]
item_meta_edge_droprates = [0.95]
...
def main():
    ...
    for r in range(args.repeat):
        ...
        G = G.to('cpu')  # !!
        model = HANRec(G, user_meta_paths, item_meta_paths,
